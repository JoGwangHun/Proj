...
<header class="site-header sticky-top py-1">
	<nav
		...
		</a> <a class="py-2 d-none d-md-inline-block" href="index.do">홈페이지</a> <a
			class="py-2 d-none d-md-inline-block" href="thingList.do">상품리스트</a>
		<form action="cartList.do">
			<input type="hidden" name="user_id" value="${id }" />
			<button class="btn_self bkcolor" type="submit">장바구니</button>
			<span class="badge bg-light text-dark">${cartCnt }</span>
		</form>
		<c:choose>
			<c:when test="${!empty id }">
				<nav id="nav1">
					<a id="a1" href="#">${id }님 </a> <a id="a1" href="memberInfo.do">회원
						정보</a> <a id="a1" href="memberLogOut.do">LogOut</a>
					<div class="animation start-home"></div>
				</nav>
			</c:when>
			<c:otherwise>
				<nav id="nav2">
					<a id="a2" href="memberLogin.do">로그인 </a> <a id="a2"
